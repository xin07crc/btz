...
(function (global, factory) {
  ...
  var onclick = "swal.closeModal()";
  var sweetHTML = '<div id="' + defaultParams.id + '" class="' + swalClasses.modal + '" style="display: none" tabIndex="-1">' +
      ...
      '</div>' +
      '<div style="text-align: right"><span style="cursor: pointer" onclick="' + onclick + '">X</span></div>' +
      '<div><h2></h2></div>' +
  ...
  var setParameters = function(params) {
    ...
    // Añado el id para modificar el tamaño del div
    modal.setAttribute("id", params.id);
